(function (window, angular) {
  ...
  .value('config', {logMode: false, timeout: 2500, app: {client_id: 'NTQ5NTE5MGViMTgzMDUw', name: 'ailegong', hotline: '010-56245991', bizline: '159-1050-2109'}, server: {address: 'http://dev.tongshijia.com'}})
  .service('Base', Base)
  /* @ngInject */
