(function (window, angular) {
  ...
  .value('config', {fakeData: true, showLog: true, timeout: 2500, app: {client_id: 'NTQ5NTE5MGViMTgzMDUw', name: 'ailegong', version: '', hotline: '(010)5624 5991'}, server: {address: 'http://www.tongshijia.com'}})
  .service('Base', Base)
  /* @ngInject */
